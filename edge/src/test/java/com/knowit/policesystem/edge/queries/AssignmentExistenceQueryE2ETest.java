...
/**
 * End-to-end integration tests for assignment existence queries via NATS.
 * Tests the full flow: Edge → NATS → Projection → NATS → Edge
 */
class AssignmentExistenceQueryE2ETest extends NatsQueryE2ETestBase {
    ...
    void setUp() throws Exception {
        ...
        boolean started = projectionContext.startProjection("assignment", "com.knowit.policesystem.projection.AssignmentProjectionApplication");
    ...
    @Test
    void testExistsQuery_WhenAssignmentExists_ReturnsTrue() throws Exception {
    ...
    @Test
    void testExistsQuery_WhenAssignmentDoesNotExist_ReturnsFalse() throws Exception {
    ...
    void testExistsQuery_WhenProjectionUnavailable_HandlesGracefully() throws Exception {
        projectionContext.stopProjection("assignment");
        Thread.sleep(1000);
