...
/**
 * End-to-end integration tests for incident get queries via NATS.
 */
class IncidentGetQueryE2ETest extends NatsQueryE2ETestBase {
    ...
    @Test
    void testGetQuery_WhenIncidentExists_ReturnsFullData() throws Exception {
        ...
        Object data = projectionQueryService.get("incident", incidentId);
        assertThat(data).isNotNull();

        Map<String, Object> incidentData = responseObjectMapper.convertValue(data,
                TypeFactory.defaultInstance().constructMapType(Map.class, String.class, Object.class));

        assertThat(incidentData.get("incidentId")).isEqualTo(incidentId);
        assertThat(incidentData.get("incidentNumber")).isEqualTo("2024-INC-001");
        assertThat(incidentData.get("priority")).isEqualTo("High");
        assertThat(incidentData.get("status")).isEqualTo("Reported");
    }

    @Test
    void testGetQuery_WhenIncidentDoesNotExist_ReturnsNull() throws Exception {
        String nonExistentIncidentId = "INC-NONEXISTENT-" + UUID.randomUUID();
        Object data = projectionQueryService.get("incident", nonExistentIncidentId);
